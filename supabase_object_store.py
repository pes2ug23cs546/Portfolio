...
SUPABASE_URL = "https://zshtlfckmilnkjgddtrp.supabase.co" 
SUPABASE_KEY = "sb_publishable_CVrgu90LNPiryAMGzYK6Ow_IPQx1mzb" 

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "PES2UG23CS546" # Name of the bucket to be created
image_path = "PES2UG23CS546.jpeg"  # Replace with the local image path
image_name = "PES2UG23CS546.jpeg"  # Desired name for the uploaded file
...
try:
    ...
    options={
        ...
        "allowed_mime_types": ["image/jpeg"], # Allow only PNG images
